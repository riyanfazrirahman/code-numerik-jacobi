...
function createInputGrid() {
  ...
  gridHtml += '<div class="d-flex justify-content-between mt-2">';
  gridHtml +=
    '<button id="showJacobiCalculations" class="btn btn-primary me-1 w-100">Calculations Jacobi</button>';
  gridHtml +=
    '<button id="showGaussSeidelCalculations" class="btn btn-primary ms-1 w-100">Calculations Gauss Seidel</button>';
  gridHtml += "</div>";
